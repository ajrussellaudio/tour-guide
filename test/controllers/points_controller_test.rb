...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { image_url: @point.image_url, info: @point.info, latitude: @point.latitude, longitude: @point.longitude, name: @point.name } }, as: :json
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { image_url: @point.image_url, info: @point.info, latitude: @point.latitude, longitude: @point.longitude, name: @point.name } }, as: :json
    assert_response 200
  end
